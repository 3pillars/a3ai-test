...
*Rationale*: This project requires specialized skills which command premium rates.
...
|--------|-------|
| Total Code Value | $[X] |
| Claude Active Hours | [X] hrs |
| Value per Claude Hour | $[X,XXX]/hr |
| Speed Multiplier (vs human) | [X]× faster |
| Cost Savings vs Traditional Dev | $[X] |
| Claude ROI | [X]× |
...
2. Calculate development hours (Step 2)
3. Research current market rates (Step 3)
4. Factor in organizational overhead (Step 4)
5. Calculate full team cost (Step 5)
6. Generate the final estimate (Step 6)
7. Calculate Claude ROI (Step 7)
